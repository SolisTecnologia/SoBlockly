...
Blockly.Toolbox.prototype.init = function() {
  ...
  //<!--  ( Modified by RLC Solis Tecnologia) Insert Color Group Blocks -->
  changeGroupBlocksColor();
};
...
goog.inherits(Blockly.Toolbox.TreeSeparator, Blockly.Toolbox.TreeNode);
  ...
  //<!--  ( Modified by RLC Solis Tecnologia) Functions to Change Color Group -->
function changeGroupBlocksColor(){

  var menuItems = [
    { id: ":1", color: "#4C97FF", color_over: "#4b89e0"},  // MiniSobot - Drive
    { id: ":3", color: "#9966FF", color_over: "#8b60e2"},  // MiniSobot - Actuator
    { id: ":5", color: "#CF63CF", color_over: "#b156b1"},  // MiniSobot - Input
    { id: ":7", color: "#FFBF00", color_over: "#BF6702"},  // Logic
    { id: ":9", color: "#FFAB19", color_over: "#f0a21b"},  // Loops
    { id: ":b", color: "#5CB1D6", color_over: "#519fc0"},  // Math
    { id: ":d", color: "#59C059", color_over: "#4faa4f"},  // Text
    { id: ":f", color: "#ce3b28", color_over: "#993427"},  // Variables
    { id: ":h", color: "#FF6680", color_over: "#e45d74"},  // Functions
    { id: ":j", color: "#08991c", color_over: "#098a1a"},  // InputOutput
    { id: ":l", color: "#99CC00", color_over: "#7B9E14"},  // Time
    { id: ":n", color: "#0000CC", color_over: "#000064"}   // Comms
  ];
  ...
  menuItems.forEach(function(item) {
    ...
    menuItem.style.borderRadius = "16px";
    menuItem.style.margin = "8px 8px";
    menuItem.onmouseover = function() {
      menuItem.style.backgroundColor = item.color_over;
    };
