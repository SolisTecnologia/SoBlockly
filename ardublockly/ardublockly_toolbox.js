...
'<xml>' +
//   ( Modified by RLC Solis Tecnologia) Insert MiniSobot Blocks 
'	<category name="MiniSobot - Drive">' +
'		<block type="drive_forward"></block>' +
'		<block type="drive_backward"></block>' +
'		<block type="drive_curve_left"></block>' +
'		<block type="drive_curve_right"></block>' +
'		<block type="drive_curve_differential_left"></block>' +
'		<block type="drive_curve_differential_right"></block>' +
'		<block type="drive_break"></block>' +
'	</category>' +
'  <sep></sep>' +
'	<category name="MiniSobot - Actuator">' +
'		<block type="led_rgb"></block>' +
'		<block type="buzzer"></block>' +
'		<block type="stop_buzzer"></block>' +
'	</category>' +
'  <sep></sep>' +
'	<category name="MiniSobot - Input">' +
'		<block type="read_button"></block>' +
'		<block type="read_ultrassonic"></block>' +
...
//   ( Modified by RLC Solis Tecnologia) Removing unused blocks
// '  <sep></sep>' +
